	...
	<div id="crud_gral"></div>
		...
		<div id="contengo" style="margin:0px auto;">
			<div class="container" style="border: 1px solid;padding:15px;"  >
				...
				<div class="row">
			      <div class="col-md-4">
			      			<div style="font-weight:bold;font-size:17px">Generar FACTURA a partir de un ALBARAN:</div>
			  	  </div>
			      <div class="col-md-2">
			      			<div>
					  			<button class = "btn btn-success" onclick="unicoAlbaran()">Un Albarán</button>
			      			</div>
			      </div>
			      <div class="col-md-2">
			      			<div>
...
<script type="text/javascript">
	...
	var g_numero_albaran="";
		...
		function unicoAlbaran(){

					sw_consulta=true;
					document.getElementById("leyenda").innerHTML="Seleccionar un Albaran";
					document.getElementById("nuevaVentana").style.width="70%";
					...
					'<div class="container">'+
						'<div class="row">'+
							'<div class="col-md-2">'+
				    	  	...
				    	  	'</div>'+
							'<div class="col-md-4">'+
								'<div style="font-size:16px;font-weight:bold;">Albaran núm.:'+'<input type="text" id="numero_albaran" size="14" onchange="leoAlbaran()"/>'+
				    	  			'</div>'+
				      		'</div>'+
				 	     	'<div class="col-md-1">'+
				    	  		'<div></div>'+
				 	     	...
				 	     	'<div class="col-md-3">'+
				    	  		'<div>'+
				      			'<button onclick="preparoMostrarAlbaranes()" class="btn btn-info">CONSULTAR ALBARANES</button>'+
				      			'</div>'+
				      		'</div>'+
				      	'</div>'+
				     '</div>';
		...
		/*function consultarAlbidos() {

				resultadoconsulta.innerHTML=
					'<div class="container">'+
						'<div class="row">'+
							'<div class="col-md-4">'+
				    	  		'<div style="font-size:18px;font-weight:bold;">Consulta de Albidos'+'</div>'+
				    	  	'</div>'+
							'<div class="col-md-4">'+
								'<div style="font-size:16px;font-weight:bold;">Desde núm:'+'<input type="text" id="desde_numero_albaran" size="14" onchange="consultaDesdeAlbido()"/>'+
				    	  			'</div>'+
				      		'</div>'+
				      	'</div>'+
				     '</div>';
		...
		*/
		...
		xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?acontar_albaranes="+"si", true);
		xmlhttp.send();
	}	
	...
	function mostrarAlbaranes(pagina) {
		...
		xmlhttp.open ("GET", "../modelo/modelo_factura_diferido_albaran.php?consulta_albaranes=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas, false);
		xmlhttp.send();
	}

		function consultaDesdeAlbaran() {

			numero_albaran = document.getElementById("desde_numero_albaran").value;
			...
			var xmlhttp;
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?consulta_albaranes="+"si"+"&desde_numero_albaran="+desde_numero_albaran, false);
				xmlhttp.send();
		}

		function seleccionaAlbaran(albaran_numero) {

			overlay.style.display="none";
			nuevaVentana.style.display="none";
			numero_albaran=albaran_numero;
			numero_factura=numero_albaran;
		...
		function borraAlbCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?borra_alb_cab="+"si"+"&numero_albaran="+numero_albaran, false);
				xmlhttp.send();
		}
		function borraAlbLin() {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?borra_alb_lin="+"si"+"&numero_albaran="+numero_albaran, false);
				xmlhttp.send();
		}
		function generaHAlbLin() {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?genera_historico_albaran_lin="+"si"+"&numero_albaran="+numero_albaran+"&nuevo_numero="+nuevo_numero, false);
				xmlhttp.send();
		}

		function generaHAlbCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?genera_historico_albaran_cab="+"si"+"&numero_albaran="+numero_albaran+"&nuevo_numero="+nuevo_numero, false);
				xmlhttp.send();
		}
		...
		function generaFacturaCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?genera_factura_cab="+"si"+"&numero_albaran="+numero_albaran+"&nuevo_numero="+nuevo_numero, false);
				xmlhttp.send();
		}
		...
		function generaFacturaLin() {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?genera_factura_lineas="+"si"+"&numero_albaran="+numero_albaran+"&nuevo_numero="+nuevo_numero, false);
				xmlhttp.send();
		}
		...
		function leoAlbaran(){
			...
			numero_albaran=document.getElementById("numero_albaran").value;
			numero_factura=numero_albaran;
			veoCab();
		...
		function agregarLineas(){
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?crear_albaran="+"si", false);
				xmlhttp.send();
		...
		function editarLinea(num_linea) {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?detalle_linea="+"si", false);
				xmlhttp.send();
		...
		function muestraLinea(num_linea) {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?muestra_linea="+"si"+"&num_albaran="+g_numero_albaran+"&num_linea="+num_linea, false);
				xmlhttp.send();
			}	
		...
		function borrarLinea(num_linea) {
				...
				if (confirma){
						...
						xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?borrar_linea="+"si"+"&num_albaran="+g_numero_albaran+"&num_linea="+num_linea, false);
							xmlhttp.send();
				}
		}
		...
		xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?acontar_precios="+"si",true);
		xmlhttp.send();
	}
		...
		function mostrarPrecios(pagina) {
				...
				xmlhttp.open ("GET", "../modelo/modelo_factura_diferido_albaran.php?precios=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas+"&desdecodigo="+desdecodigo, true);
				xmlhttp.send();
	}
	...
	function preparoMostrarFacLineas() {
		...
		xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?acontar_alblineas="+"si"+"&numero_factura="+numero_factura, true);
		xmlhttp.send();
	}
	...
	function mostrarFacLineas(pagina) {
				...
				xmlhttp.onreadystatechange = function () {
					if (this.readyState === 4 && this.status === 200) {
						...
						overlay.style.display="none";
						nuevaVentana.style.display="none";
						g_numero_albaran=numero_factura;
					}
				}
		xmlhttp.open ("GET", "../modelo/modelo_factura_diferido_albaran.php?alb_lineas=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas+"&numero_factura="+numero_factura, false);
		xmlhttp.send();
	}
	...
	function veoCab() {
				...
				xmlhttp.open ("GET", "../modelo/modelo_factura_diferido_albaran.php?veo_cab=" + "si"+"&numero_factura="+numero_factura, false);
				xmlhttp.send();
	}
	...
	function leerRef()  {
		...
		xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?leer_ref="+"si", false);
		xmlhttp.send(); 
		actualizando=false;	     
	}
	...
	function guardarCambiosLinea(num_linea) {
		...
		var confirma=confirm("Grabar cambios?");
			...
			if (confirma) {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?regraba_linea="+"si"+"&numero_factura="+g_numero_albaran+"&numero_linea="+num_linea+"&almacen_ori="+gr_alm_ori+"&articulo="+gr_articulo+"&descripcion="+gr_descripcion+"&unidades="+gr_unidades+"&precio="+gr_precio+"&tipo_iva="+gr_tipo_iva+"&iva_por="+gr_iva_por+"&iva_importe="+gr_iva_importe+"&descuento_por="+gr_descuento_por+"&descuento_importe="+gr_descuento_importe+"&precio_sin_iva="+pre_precio_linea+"&importe_linea="+gr_importe_linea, false);
				xmlhttp.send();
		}
	}
	...
	function regrabaCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?regraba_cab="+"si"+"&numero_factura="+numero_factura+"&importe_neto="+gr_importe_neto+"&descuento_importe="+pre_dto_importe+"&iva_importe="+pre_iva_importe+"&importe_total="+gr_importe_linea, false);
	...
	function buscaAlmacen(id_almacen) {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?busca_almacen="+"si"+"&id_almacen="+id_almacen,false);
				xmlhttp.send();
	}
	...
	function buscaCliente(id_cliente) {
			...
			var xmlhttp;
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?busca_cliente="+"si"+"&id_cliente="+id_cliente,false);
				xmlhttp.send();
	...
	function buscaPrecios(id_articulo) {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?busca_precio="+"si"+"&id_articulo="+id_articulo,false);
				xmlhttp.send();
	}
	function calculaDto() {
	...
	function grabarHistorico_o() {
		...
		function grabaRef(){
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?graba_ref="+"si"+"$numero_linea="+numero_linea,false);
				xmlhttp.send();
	}
		function grabaRefNumeroFac(){
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido_albaran.php?graba_ref_numero_fac="+"si", false);
				xmlhttp.send();
	}
	...
	function retrocedoPaginaAlbaranes() {
	...
	function avanzoPaginaAlbaranes() {
