...
<script type="text/javascript">
	...
	var g_numero_albaran="";
		...
		function agregarLineas(){
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?crear_albaran="+"si", false);
				xmlhttp.send();
		...
		function crearCabecera(){
			...
			if (operacion=="inicio") {
				...
				operacion="nuevoalbaran";

	 				document.getElementById("leyenda").innerHTML="ALBARAN NUEVO";
					document.getElementById("nuevaVentana").style.width="60%";
					overlay.style.opacity = .7;
					if (overlay.style.display == "block") {
						overlay.style.display="none";
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?crear_cabecera="+"si", false);
				xmlhttp.send();
		}
	}
		...
		function editarLinea(num_linea) {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?detalle_linea="+"si", false);
				xmlhttp.send();
		...
		function muestraLinea(num_linea) {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?muestra_linea="+"si"+"&num_albaran="+g_numero_albaran+"&num_linea="+num_linea, false);
				xmlhttp.send();
			}	
		...
		function borrarLinea(num_linea) {
				...
				if (confirma){
						...
						xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?borrar_linea="+"si"+"&num_albaran="+g_numero_albaran+"&num_linea="+num_linea, false);
							xmlhttp.send();
				}
		}
		...
		function editarCabecera() {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?editar_cabecera="+"si", false);
				xmlhttp.send();
		...
		function grabarCabecera() {
			...
			if (cliente_valido&&almacen_valido) {
				...
				var confirme=confirm("CONFORME ALBARAN NUEVO ?");

				if (confirme) {

						grabaRefNumeroFac();
						leerRef();
						var alb_tipo="ALBARAN";
						var alb_cliente=document.getElementById("cc_cliente").value;
						var alb_tlf=document.getElementById("cc_cliente_tlf").value;
						var alb_estado="nueva";
						var alb_usuario='<?php echo $_SESSION["id_usuario"] ?>';
						var alb_domicilio_entrega=document.getElementById("cc_cliente_direccion").value;
						var alb_almacen_vta=document.getElementById("cc_alm_vta").value;
						var alb_observaciones=document.getElementById("cc_observaciones").value;
						...
						if(window.XMLHttpRequest) {
							...
							almacen_valido=false;
							cierraVentana();
							document.getElementById("numero_albaran").value=numero_albaran;
							document.getElementById("cliente").value=alb_cliente;
							buscaCliente(alb_cliente);
							...
							document.getElementById("alm_vta").value=alb_almacen_vta;
							document.getElementById("impuestos").value=0;
							document.getElementById("total_alb").value=0;
							document.getElementById("dtos").value=0;
							preparoMostrarFacLineas();	
							}
					}
						xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?grabar_cabecera="+"si"+"&alb_tipo="+alb_tipo+"&alb_cliente="+alb_cliente+"&alb_numero="+numero_albaran+"&alb_fecha="+fecha+"&alb_estado="+alb_estado+"&alb_usuario="+alb_usuario+"&alb_almacen_vta="+alb_almacen_vta+"&alb_domicilio_entrega="+alb_domicilio_entrega+"&alb_tlf="+alb_tlf+"&alb_observaciones="+alb_observaciones, false);
						xmlhttp.send();
				}
			}
        ...
        function guardarCambiosCabecera() {
				...
				if (confirme) {
						...
						var alb_cliente=document.getElementById("ed_cliente").value;
						var alb_tlf=document.getElementById("ed_cliente_tlf").value;
						var alb_domicilio_entrega=document.getElementById("ed_cliente_direccion").value;
						var alb_almacen_vta=document.getElementById("ed_alm_vta").value;
						var alb_observaciones=document.getElementById("ed_observaciones").value;
						...
						if(window.XMLHttpRequest) {
							...
							document.getElementById("total_alb").value=0;
							document.getElementById("dtos").value=0;
							ed_cliente=alb_cliente;
			 				ed_cliente_nombre=nombre_cliente;
			 				ed_nif=nif_cliente;
			 				ed_direccion=alb_domicilio_entrega;
			 				ed_tlf=alb_tlf;
			 				ed_alm_vta=alb_almacen_vta;
			 				ed_observaciones=alb_observaciones;
							preparoMostrarFacLineas();	

							}
					}
		
						xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?regrabar_cabecera="+"si"+"&alb_cliente="+alb_cliente+"&alb_numero="+numero_albaran+"&alb_domicilio_entrega="+alb_domicilio_entrega+"&alb_tlf="+alb_tlf+"&alb_almacen_vta="+alb_almacen_vta+"&alb_observaciones="+alb_observaciones, false);
						xmlhttp.send();
				}
			}
		...
		xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?acontar_precios="+"si",true);
		xmlhttp.send();
	}
		...
		function mostrarPrecios(pagina) {
				...
				xmlhttp.open ("GET", "../modelo/modelo_albaran_directo.php?precios=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas+"&desdecodigo="+desdecodigo, true);
				xmlhttp.send();
	}
	...
	function preparoMostrarFacLineas() {
		...
		xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?acontar_alblineas="+"si"+"&numero_albaran="+numero_albaran, true);
		xmlhttp.send();
	}
	...
	function mostrarFacLineas(pagina) {
				...
				xmlhttp.onreadystatechange = function () {
					if (this.readyState === 4 && this.status === 200) {
						...
						g_numero_albaran=numero_albaran;
					}
				}
		xmlhttp.open ("GET", "../modelo/modelo_albaran_directo.php?alb_lineas=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas+"&numero_albaran="+numero_albaran, false);
		xmlhttp.send();
	}
	...
	function veoCab() {
				...
				if(window.XMLHttpRequest) {
					...
					if (this.readyState === 4 && this.status === 200) {
						...
						if (buenjason) {
			 			...
			 			document.getElementById("total_alb").value=obj.importe_total;
				...
				xmlhttp.open ("GET", "../modelo/modelo_albaran_directo.php?veo_cab=" + "si"+"&numero_albaran="+numero_albaran, false);
				xmlhttp.send();
	}
	...
	function lineaOpciones() {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?opciones="+"si", true);
				xmlhttp.send();
	}
	...
	function leerRef()  {
		...
		if(window.XMLHttpRequest) {
			...
			if (this.readyState === 4 && this.status === 200) {
					...
					if (buenjason) {
			 			...
			 			ordenactual++;
			 			numero_albaran=obj.numero_albaran;
			 			fecha=obj.fechaRef;
		...
		xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?leer_ref="+"si", false);
		xmlhttp.send(); 
		actualizando=false;	     
	}
	...
	function guardarCambiosLinea(num_linea) {
		...
		var confirma=confirm("Grabar cambios?");
			...
			if (confirma) {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?regraba_linea="+"si"+"&numero_albaran="+g_numero_albaran+"&numero_linea="+num_linea+"&almacen_ori="+gr_alm_ori+"&articulo="+gr_articulo+"&descripcion="+gr_descripcion+"&unidades="+gr_unidades+"&precio="+gr_precio+"&tipo_iva="+gr_tipo_iva+"&iva_por="+gr_iva_por+"&iva_importe="+gr_iva_importe+"&descuento_por="+gr_descuento_por+"&descuento_importe="+gr_descuento_importe+"&precio_sin_iva="+pre_precio_linea+"&importe_linea="+gr_importe_linea, false);
				xmlhttp.send();
		}
	}
	function actualizaCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?actualiza_cab="+"si"+"&numero_albaran="+numero_albaran+"&old_importe_neto="+anterior_importe_neto+"&new_importe_neto="+gr_importe_neto+"&old_descuento_importe="+anterior_descuento_importe+"&new_descuento_importe="+gr_descuento_importe+"&old_iva_importe="+anterior_iva_importe+"&new_iva_importe="+gr_iva_importe+"&old_importe_total="+anterior_importe_linea+"&new_importe_total="+gr_importe_linea, false);
	...
	function regrabaCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?regraba_cab="+"si"+"&numero_albaran="+numero_albaran+"&importe_neto="+gr_importe_neto+"&descuento_importe="+pre_dto_importe+"&iva_importe="+pre_iva_importe+"&importe_total="+gr_importe_linea, false);
	...
	function buscaAlmacen(id_almacen) {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?busca_almacen="+"si"+"&id_almacen="+id_almacen,false);
				xmlhttp.send();
	}
	...
	function buscaCliente(id_cliente) {
			...
			var xmlhttp;
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?busca_cliente="+"si"+"&id_cliente="+id_cliente,false);
				xmlhttp.send();
	...
	function buscaPrecios(id_articulo) {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?busca_precio="+"si"+"&id_articulo="+id_articulo,false);
				xmlhttp.send();
	}
	function calculaDto() {
	...
	function grabarHistorico_o() {
		...
		function grabaRef(){
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?graba_ref="+"si"+"$numero_linea="+numero_linea,false);
				xmlhttp.send();
	}
		function grabaRefNumeroFac(){
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_directo.php?graba_ref_numero_alb="+"si", false);
				xmlhttp.send();
	}
	...
	function editarOtroAlbaran() {

			 numero_albaran=prompt("ENTRE NUMERO DE ALBARAN A EDITAR");

			if 	(numero_albaran!=null) {
