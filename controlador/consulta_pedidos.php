...
<div id="overlay"></div>
<div id="nuevaVentana">
	<div id="box-header"><label id="leyenda" style="margin-left:35%;">Detalle Pedido</label></div>
...
<script type="text/javascript">
	...
	function MostrarPedidos(pagina){
		...
		xmlhttp.open("GET", "../modelo/modelo_consulta_pedidos.php?pedidos=" + "pedidos"+"&pagina="+pagina+"&num_paginas="+num_paginas, true);
		xmlhttp.send();
	}
	...
	function preparoMostrarPedidos(){
		...
		xmlhttp.open("GET", "../modelo/modelo_consulta_pedidos.php?acontar="+"si", true);
		xmlhttp.send();
	}

	function verLineas(num_pedido) {


		numero_pedido=num_pedido;
		document.getElementById("leyenda").innerHTML="Detalle Pedido";
		document.getElementById("nuevaVentana").style.width="70%";
					...
					preparoMostrarPedLineas();
	}

	function preparoMostrarPedLineas() {
		...
		xmlhttp.open("GET", "../modelo/modelo_consulta_pedidos.php?acontar_pedlineas="+"si"+"&numero_pedido="+numero_pedido, true);
		xmlhttp.send();
	}
	
	function mostrarPedLineas(pagina) {
		...
		xmlhttp.open ("GET", "../modelo/modelo_consulta_pedidos.php?ped_lineas=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas+"&numero_pedido="+numero_pedido, false);
		xmlhttp.send();
	}

	leerRef();
	preparoMostrarPedidos();

	function desdeCodigoPL(){

			desdecodigo=document.getElementById("desdecodigo").value;
			preparoMostrarPedLineas();
	}

	function iraPaginaPL(){
			...
			if (eligepagina >= 1 && eligepagina <=num_paginas) {
				...
				mostrarPedLineas(muestro_pagina);
			}
	}

	function retrocedoPaginaPL() {
