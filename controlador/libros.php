...
<script type="text/javascript">
	...
	function mostrarLibros(pagina){
		...
		xmlhttp.open("GET", "../modelo/modelo_libros.php?libros=" + "libros"+"&clasifica="+clasifica+"&pagina="+pagina+"&num_paginas="+num_paginas+"&sw_solo="+sw_solo+"&propietario="+depropietario, true);
		xmlhttp.send();
	}
}
	function porId(){
	...
	function preparoMostrarLibros(){
		...
		xmlhttp.open("GET", "../modelo/modelo_libros.php?acontar="+"si"+"&sw_solo="+sw_solo+"&propietario="+depropietario, true);
		xmlhttp.send();
	}
	...
	function editarLibros(id) {
		...
		var guardo_propietario=document.getElementById(propietarioID).value;
	...
	function actualizarLibros(id) {
		...
		if (document.getElementById("propietario"+id+"-editar").value!=guardo_propietario) {

			var propietarioActualizado= document.getElementById("propietario"+id+"-editar").value; }
			} else { var propietarioActualizado= guardo_propietario; }
	...
	function soloPropietario() {
		...
		depropietario=document.getElementById("solopropiedad").value;

		
		if (depropietario!='TODOS') {
			sw_solo="si";
		} else {
			sw_solo="no";
		}
