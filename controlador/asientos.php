...
<div id="wrapper"> 
	<div id="crud_gral"></div>
	  ...
	  <div id="input-apuntes" class="container" style="border: 1px solid;padding:15px;margin-left:150 auto;">
	  <form>
			<fieldset> 
      			<div id="div1">
			...
			<fieldset id="cuartofield">
      		...
      		<fieldset id="quintofield">
				<div id="divD">
					...
					<input id="debeasiento" readonly="readonly"  class='botoness'>
					<button type="button" class='botones'>Asiento HABER:</button>
					<input id="haberasiento" readonly="readonly" class='botoness'>
					<button type="button" class='botones'>Saldo asiento:</button>
					<input id="saldoasiento" readonly="readonly" class='botoness'>
				</div>
      		</fieldset>
	...
	<div id="muestra-apuntes" style="margin-left:0px;"></div>
</div>
<script type="text/javascript">
	...
	function leerRef()  {
		...
		actualizando=false;	     
				...
				// esta rutina esta bajada literal de https://www.yoelprogramador.com/formatear-numeros-con-javascript/
	...
	function editarApunte(id) {
		...
		if (apunteposible) {
				...
				document.getElementById(documentoID).innerHTML = '<input type ="text" id="'+editardocumentoID+'" value="'+documentoid+'" size="15">';
				...
				document.getElementById(importe_debeID).innerHTML = '<input type ="text" id="'+editarimporte_debeID+'" value="'+importe_debeid+'" size="7">';
				document.getElementById(importe_haberID).innerHTML = '<input type ="text" id="'+editarimporte_haberID+'" value="'+importe_haberid+'" size="7">';
