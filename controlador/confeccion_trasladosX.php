		...
		<div style="border: #679B9B solid 1px">
			<table class = "table">
	 			...
	 			<td><input type="text" id="almacen_ori" size="3" maxlength="3" style="width:90px;height:28px;font-weight:bold;"  /></td>
	  			<td><input type="text" id="descripcion_ori" size="40" maxlength="40" readonly="readonly" style="width:500px;height:28px;font-size:16px;"/></td>
	  		...
	  		<tr>
	  			...
	  			<td><input type="text" id="descripcion_des" size="40" maxlength="40"  readonly="readonly" style="width:500px;height:28px;font-size:16px;"/></td>
	  			<td><button onclick="consultaAlmacen('b')" class="btn btn-info"> CONSULTA ALMACEN </td>
	  		</tr>
	  		</table>
	  		<table class = "table">
	  		<td></td>
	  		...
	  		<td><input type="text" id="documento" size="16" maxlength="16"  style="width:175px;height:28px;font-size:16px;"/></td>
															...
															enfoca("unidades");
																...
																if (!existe_alm) {
																		...
																		enfoca("almacen_des");
																			...
																			var altasn=confirm("ARTICULO NO EXISTE EN ALMACEN DESTINO, ¿ DESEA DARLO DE ALTA ?");
																			if (altasn=="si") {
