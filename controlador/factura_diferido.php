	...
	<div id="crud_gral"></div>
		...
		<div id="contengo" style="margin:0px auto;">
			<div class="container" style="border: 1px solid;padding:15px;"  >
				...
				<div class="row">
			      <div class="col-md-4">
			      			<div style="font-weight:bold;font-size:17px">Generar FACTURA con ORIGEN:</div>
			  	  </div>
			      <div class="col-md-2">
			      			<div>
			      ...
			      <div class="col-md-2">
			 	  ...
			 	  <div class="col-md-2">
			      			<div>
					  			<button class = "btn btn-success" onclick="unicoPedido()">Un Albarán </button>
			      			</div>
			      </div>
			      <div class="col-md-2">
			      			<div>
...
<script type="text/javascript">
	...
	var numero_pedido="";
		...
		*/
		...
		xmlhttp.open("GET", "../modelo/modelo_factura_diferido.php?acontar_pedidos="+"si", true);
		xmlhttp.send();
	}	
	...
	function mostrarPedidos(pagina) {
		...
		xmlhttp.open ("GET", "../modelo/modelo_factura_diferido.php?consulta_pedidos=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas, false);
		xmlhttp.send();
	}
		...
		function consultaDesdePedido() {
			...
			var xmlhttp;
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido.php?consulta_pedidos="+"si"+"&desde_numero_pedido="+desde_numero_pedido, false);
				xmlhttp.send();
		}
		...
		function agregarLineas(){
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido.php?crear_pedido="+"si", false);
				xmlhttp.send();
		...
		function editarLinea(num_albaran, num_linea) {
				...
				xmlhttp.onreadystatechange = function () {
					if (this.readyState === 4 && this.status === 200) {
						...
						resultadoconsulta.innerHTML=xmlhttp.responseText;
						resultadoconsulta.innerHTML+='<button class = "btn btn-success" onclick="guardarCambiosLinea('+num_albaran+','+ num_linea+')" style="margin-left:75%;">GRABAR CAMBIOS</button>';
	...
	function preparoMostrarFacLineas() {
		...
		xmlhttp.open("GET", "../modelo/modelo_factura_diferido.php?acontar_alblineas="+"si"+"&numero_factura="+numero_factura, true);
		xmlhttp.send();
	}
	...
	function mostrarFacLineas(pagina) {
		...
		xmlhttp.open ("GET", "../modelo/modelo_factura_diferido.php?alb_lineas=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas+"&numero_factura="+numero_factura, false);
		xmlhttp.send();
	}
	...
	function veoCab() {
				...
				xmlhttp.open ("GET", "../modelo/modelo_factura_diferido.php?veo_cab=" + "si"+"&numero_factura="+numero_factura, false);
				xmlhttp.send();
	}
	...
	function grabarLinea() {
		...
		var confirma=confirm("Grabar linea de albaran?");
			...
			if (confirma) {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido.php?graba_linea="+"si"+"&numero_factura="+numero_factura+"&numero_linea="+numero_linea+"&almacen_ori="+gr_alm_ori+"&articulo="+gr_articulo+"&descripcion="+gr_descripcion+"&unidades="+gr_unidades+"&precio="+gr_precio+"&tipo_iva="+gr_tipo_iva+"&iva_por="+gr_iva_por+"&iva_importe="+gr_iva_importe+"&descuento_por="+gr_descuento_por+"&descuento_importe="+gr_descuento_importe+"&precio_sin_iva="+pre_precio_linea+"&importe_linea="+gr_importe_linea, false);
				xmlhttp.send();
		}
	}

	function guardarCambiosLinea(num_albaran, num_linea) {
		...
		var confirma=confirm("Grabar cambios?");
			...
			if (confirma) {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido.php?regraba_linea="+"si"+"&numero_factura="+num_albaran+"&numero_linea="+num_linea+"&almacen_ori="+gr_alm_ori+"&articulo="+gr_articulo+"&descripcion="+gr_descripcion+"&unidades="+gr_unidades+"&precio="+gr_precio+"&tipo_iva="+gr_tipo_iva+"&iva_por="+gr_iva_por+"&iva_importe="+gr_iva_importe+"&descuento_por="+gr_descuento_por+"&descuento_importe="+gr_descuento_importe+"&precio_sin_iva="+pre_precio_linea+"&importe_linea="+gr_importe_linea, false);
				xmlhttp.send();
		}
	}
	function actualizaCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido.php?actualiza_cab="+"si"+"&numero_factura="+numero_factura+"&old_importe_neto="+anterior_importe_neto+"&new_importe_neto="+gr_importe_neto+"&old_descuento_importe="+anterior_descuento_importe+"&new_descuento_importe="+gr_descuento_importe+"&old_iva_importe="+anterior_iva_importe+"&new_iva_importe="+gr_iva_importe+"&old_importe_total="+anterior_importe_linea+"&new_importe_total="+gr_importe_linea, false);
	...
	function regrabaCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_diferido.php?regraba_cab="+"si"+"&numero_factura="+numero_factura+"&importe_neto="+gr_importe_neto+"&descuento_importe="+pre_dto_importe+"&iva_importe="+pre_iva_importe+"&importe_total="+gr_importe_linea, false);
