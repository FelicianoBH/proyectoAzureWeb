...
<div class="container" style="border: 1px solid;padding:15px;margin-left:150 auto;">
	 ...
	 <div class="row">
      ...
      <div class="col-md-3">
       ...
       <div class="col-md-2">
      			<div>Núm:
		  			<input type="text" readonly id="numero_factura"  size="16"/>
      			</div>
      </div>
      </div>
...
<script type="text/javascript">
	...
	var g_numero_factura="";
		...
		function agregarLineas(){
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?crear_factura="+"si", false);
				xmlhttp.send();
		...
		function crearCabecera(){
			...
			if (operacion=="inicio") {
				...
				operacion="nuevafactura";

					document.getElementById("leyenda").innerHTML="FACTURA NUEVA";
					document.getElementById("nuevaVentana").style.width="60%";
					overlay.style.opacity = .7;
					if (overlay.style.display == "block") {
						overlay.style.display="none";
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?crear_cabecera="+"si", false);
				xmlhttp.send();
		}
	}
		...
		function editarLinea(num_linea) {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?detalle_linea="+"si", false);
				xmlhttp.send();
		...
		function muestraLinea(num_linea) {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?muestra_linea="+"si"+"&num_factura="+g_numero_factura+"&num_linea="+num_linea, false);
				xmlhttp.send();
			}	
		...
		function borrarLinea(num_linea) {
				...
				if (confirma){
						...
						xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?borrar_linea="+"si"+"&num_factura="+g_numero_factura+"&num_linea="+num_linea, false);
							xmlhttp.send();
				}
		}
		...
		function editarCabecera() {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?editar_cabecera="+"si", false);
				xmlhttp.send();
		...
		function grabarCabecera() {
			...
			if (cliente_valido&&almacen_valido) {
				...
				var confirme=confirm("CONFORME FACTURA NUEVA ?");

				if (confirme) {

						grabaRefNumeroFac();
						leerRef();
						var fac_tipo="FACTURA";
						var fac_cliente=document.getElementById("cc_cliente").value;
						var fac_tlf=document.getElementById("cc_cliente_tlf").value;
						var fac_estado="nueva";
						var fac_usuario='<?php echo $_SESSION["id_usuario"] ?>';
						var fac_domicilio_entrega=document.getElementById("cc_cliente_direccion").value;
						var fac_almacen_vta=document.getElementById("cc_alm_vta").value;
						var fac_observaciones=document.getElementById("cc_observaciones").value;
						...
						if(window.XMLHttpRequest) {
							...
							document.getElementById("cliente").value=fac_cliente;
							buscaCliente(fac_cliente);
							...
							document.getElementById("alm_vta").value=fac_almacen_vta;
							document.getElementById("impuestos").value=0;
							document.getElementById("total_fac").value=0;
							document.getElementById("dtos").value=0;
							preparoMostrarFacLineas();	
							}
					}
						xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?grabar_cabecera="+"si"+"&fac_tipo="+fac_tipo+"&fac_cliente="+fac_cliente+"&fac_numero="+numero_factura+"&fac_fecha="+fecha+"&fac_estado="+fac_estado+"&fac_usuario="+fac_usuario+"&fac_almacen_vta="+fac_almacen_vta+"&fac_domicilio_entrega="+fac_domicilio_entrega+"&fac_tlf="+fac_tlf+"&fac_observaciones="+fac_observaciones, false);
						xmlhttp.send();
				}
			}
        ...
        function guardarCambiosCabecera() {
				...
				if (confirme) {
						...
						var fac_cliente=document.getElementById("ed_cliente").value;
						var fac_tlf=document.getElementById("ed_cliente_tlf").value;
						var fac_domicilio_entrega=document.getElementById("ed_cliente_direccion").value;
						var fac_almacen_vta=document.getElementById("ed_alm_vta").value;
						var fac_observaciones=document.getElementById("ed_observaciones").value;
						...
						if(window.XMLHttpRequest) {
							...
							document.getElementById("total_fac").value=0;
							document.getElementById("dtos").value=0;
							ed_cliente=fac_cliente;
			 				ed_cliente_nombre=nombre_cliente;
			 				ed_nif=nif_cliente;
			 				ed_direccion=fac_domicilio_entrega;
			 				ed_tlf=fac_tlf;
			 				ed_alm_vta=fac_almacen_vta;
			 				ed_observaciones=fac_observaciones;
							preparoMostrarFacLineas();	

							}
					}
		
						xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?regrabar_cabecera="+"si"+"&fac_cliente="+fac_cliente+"&fac_numero="+numero_factura+"&fac_domicilio_entrega="+fac_domicilio_entrega+"&fac_tlf="+fac_tlf+"&fac_almacen_vta="+fac_almacen_vta+"&fac_observaciones="+fac_observaciones, false);
						xmlhttp.send();
				}
			}
		...
		xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?acontar_precios="+"si",true);
		xmlhttp.send();
	}
		...
		function mostrarPrecios(pagina) {
				...
				xmlhttp.open ("GET", "../modelo/modelo_factura_directa.php?precios=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas+"&desdecodigo="+desdecodigo, true);
				xmlhttp.send();
	}
	...
	function preparoMostrarFacLineas() {
		...
		xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?acontar_faclineas="+"si"+"&numero_factura="+numero_factura, true);
		xmlhttp.send();
	}
	...
	function mostrarFacLineas(pagina) {
				...
				xmlhttp.onreadystatechange = function () {
					if (this.readyState === 4 && this.status === 200) {
						...
						g_numero_factura=numero_factura;
					}
				}
		xmlhttp.open ("GET", "../modelo/modelo_factura_directa.php?fac_lineas=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas+"&numero_factura="+numero_factura, false);
		xmlhttp.send();
	}
	...
	function veoCab() {
				...
				xmlhttp.open ("GET", "../modelo/modelo_factura_directa.php?veo_cab=" + "si"+"&numero_factura="+numero_factura, false);
				xmlhttp.send();
	}
	...
	function lineaOpciones() {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?opciones="+"si", true);
				xmlhttp.send();
	}
	...
	function leerRef()  {
		...
		xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?leer_ref="+"si", false);
		xmlhttp.send(); 
		actualizando=false;	     
	}
	...
	function grabarLinea() {
		...
		var confirma=confirm("Grabar linea de factura?");
	...
	function guardarCambiosLinea(num_linea) {
		...
		var confirma=confirm("Grabar cambios?");
			...
			if (confirma) {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?regraba_linea="+"si"+"&numero_factura="+g_numero_factura+"&numero_linea="+num_linea+"&almacen_ori="+gr_alm_ori+"&articulo="+gr_articulo+"&descripcion="+gr_descripcion+"&unidades="+gr_unidades+"&precio="+gr_precio+"&tipo_iva="+gr_tipo_iva+"&iva_por="+gr_iva_por+"&iva_importe="+gr_iva_importe+"&descuento_por="+gr_descuento_por+"&descuento_importe="+gr_descuento_importe+"&precio_sin_iva="+pre_precio_linea+"&importe_linea="+gr_importe_linea, false);
				xmlhttp.send();
		}
	}
	function actualizaCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?actualiza_cab="+"si"+"&numero_factura="+numero_factura+"&old_importe_neto="+anterior_importe_neto+"&new_importe_neto="+gr_importe_neto+"&old_descuento_importe="+anterior_descuento_importe+"&new_descuento_importe="+gr_descuento_importe+"&old_iva_importe="+anterior_iva_importe+"&new_iva_importe="+gr_iva_importe+"&old_importe_total="+anterior_importe_linea+"&new_importe_total="+gr_importe_linea, false);
	...
	function regrabaCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?regraba_cab="+"si"+"&numero_factura="+numero_factura+"&importe_neto="+gr_importe_neto+"&descuento_importe="+pre_dto_importe+"&iva_importe="+pre_iva_importe+"&importe_total="+gr_importe_linea, false);
	...
	function buscaAlmacen(id_almacen) {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?busca_almacen="+"si"+"&id_almacen="+id_almacen,false);
				xmlhttp.send();
	}
	...
	function buscaCliente(id_cliente) {
			...
			var xmlhttp;
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?busca_cliente="+"si"+"&id_cliente="+id_cliente,false);
				xmlhttp.send();
	...
	function buscaPrecios(id_articulo) {
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?busca_precio="+"si"+"&id_articulo="+id_articulo,false);
				xmlhttp.send();
	}
	function calculaDto() {
	...
	function grabarHistorico_o() {
		...
		function grabaRef(){
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?graba_ref="+"si"+"$numero_linea="+numero_linea,false);
				xmlhttp.send();
	}
		function grabaRefNumeroFac(){
				...
				xmlhttp.open("GET", "../modelo/modelo_factura_directa.php?graba_ref_numero_fac="+"si", false);
				xmlhttp.send();
	}
	...
	function editarOtraFactura() {

			 numero_factura=prompt("ENTRE NUMERO DE FACTURA A EDITAR");
