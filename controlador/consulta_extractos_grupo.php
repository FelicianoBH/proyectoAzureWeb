	  ...
	  <div id="contengo" style="margin:0px auto;">
	  	...
	  	<form>
      		...
      		<fieldset>
      			...
      			<div id="div3">
      				<label>              </label>
					<button type="button" class='botones' onclick="preparaExtractos('c')">CONSULTAR</button>
      				<label>              </label>
					<button type="button" class='botones' onclick="preparaExtractos('l')">LISTAR</button>
				</div>
      		</fieldset>
...
<script type="text/javascript">
	...
	var resultado_imprimir = document.getElementById("lista_extractos");
	...
	function preparaExtractos(salida){
	...
	function mostrarExtractos(pagina, salida){
		...
		xmlhttp.open("GET", "../modelo/modelo_extracto_grupos.php?extractos="+"si"+"&pagina="+pagina+"&num_paginas="+num_paginas+"&decuenta="+decuenta+"&hacuenta="+hacuenta+"&desdefecha="+desdefecha+"&desdeasto="+desdeasto+"&hastafecha="+hastafecha+"&hastaasto="+hastaasto+"&salida="+salida, true);
		xmlhttp.send();
	}
