	...
	<div id="titulo-referencias">
		<div class="container" >
	 			<div class="row">
					<div class="col-sd-1">
			      			<div>
			       				<i class="fas fa-toggle-on fa-3x" style="float:left;"></i>
	v		      			</div>
			      	</div>
		...
		<div id="contengo" style="margin:0px auto;">
			<div class="container" style="border: 1px solid;padding:15px;"  >
				...
				<div class="row">
			      ...
			      <div class="col-md-4">
			      			<div style="font-weight:bold;font-size:17px">Generar ALBARÁN a partir de un PEDIDO :</div>
			  	  </div>
			      <div class="col-md-2">
			      			<div>
					  			<button class = "btn btn-success" onclick="unicoPedido()">Un único  Pedido</button>
			      			</div>
			      </div>
			      <div class="col-md-2">
			      			<div>
...
<script type="text/javascript">
	...
	var g_numero_albaran="";
		...
		*/
		...
		xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?acontar_pedidos="+"si", true);
		xmlhttp.send();
	}	
	...
	function mostrarPedidos(pagina) {
		...
		xmlhttp.open ("GET", "../modelo/modelo_albaran_diferido.php?consulta_pedidos=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas, false);
		xmlhttp.send();
	}
		...
		function consultaDesdePedido() {
			...
			var xmlhttp;
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?consulta_pedidos="+"si"+"&desde_numero_pedido="+desde_numero_pedido, false);
				xmlhttp.send();
		}
		...
		function seleccionaPedido(pedido_numero) {
			...
			numero_albaran=numero_pedido;
			
			veoCab();

		}

		function generarElAlbaran(){

			var confirmar = confirm("CONFIRMA GENERAR ALBARAN DE ESTE PEDIDO ?");

			if (confirmar) {
				leerRef();
				nuevo_numero=numero_albaran;
				nuevo_numero++;
				grabaRefNumeroAlb();
				generaAlbaranCab();
				generaAlbaranLin();
				...
				leerRef();
			 	...
			 	document.getElementById("total_alb").value="";
		...
		function borraPedCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?borra_ped_cab="+"si"+"&numero_pedido="+numero_pedido, false);
				xmlhttp.send();
		}
		function borraPedLin() {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?borra_ped_lin="+"si"+"&numero_pedido="+numero_pedido, false);
				xmlhttp.send();
		}
		function generaHPedLin() {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?genera_historico_pedido_lin="+"si"+"&numero_pedido="+numero_pedido+"&nuevo_numero="+nuevo_numero, false);
				xmlhttp.send();
		}
		...
		function generaHPedCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?genera_historico_pedido_cab="+"si"+"&numero_pedido="+numero_pedido+"&nuevo_numero="+nuevo_numero, false);
				xmlhttp.send();
		}

		function generaAlbaranCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?genera_albaran_cab="+"si"+"&numero_pedido="+numero_pedido+"&nuevo_numero="+nuevo_numero, false);
				xmlhttp.send();
		}

		function generaAlbaranLin() {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?genera_albaran_lineas="+"si"+"&numero_pedido="+numero_pedido+"&nuevo_numero="+nuevo_numero, false);
				xmlhttp.send();
		}
		...
		function agregarLineas(){
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?crear_pedido="+"si", false);
				xmlhttp.send();
		...
		function crearCabecera(){
			...
			if (operacion=="inicio") {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?crear_cabecera="+"si", false);
				xmlhttp.send();
		}
	}
		...
		function editarLinea(num_linea) {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?detalle_linea="+"si", false);
				xmlhttp.send();
		...
		function detallesLinea(num_linea){
				...
				xmlhttp.onreadystatechange = function () {
					if (this.readyState === 4 && this.status === 200) {
						...
						muestraLinea(num_albaran, num_linea);
					}
				}
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?detalle_linea="+"si", false);
				xmlhttp.send();
		...
		function muestraLinea(num_linea) {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?muestra_linea="+"si"+"&num_albaran="+g_numero_albaran+"&num_linea="+num_linea, false);
				xmlhttp.send();
			}	
		...
		function borrarLinea(num_linea) {
				...
				if (confirma){
						...
						xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?borrar_linea="+"si"+"&num_albaran="+g_numero_albaran+"&num_linea="+num_linea, false);
							xmlhttp.send();
				}
		}
		...
		function editarCabecera() {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?editar_cabecera="+"si", false);
				xmlhttp.send();
        ...
        function guardarCambiosCabecera() {
				...
				if (confirme) {
						...
						xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?regrabar_cabecera="+"si"+"&alb_cliente="+alb_cliente+"&alb_numero="+numero_albaran+"&alb_domicilio_entrega="+alb_domicilio_entrega+"&alb_tlf="+alb_tlf+"&alb_almacen_vta="+alb_almacen_vta+"&alb_observaciones="+alb_observaciones, false);
						xmlhttp.send();
				}
			}
		...
		xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?acontar_precios="+"si",true);
		xmlhttp.send();
	}
		...
		function mostrarPrecios(pagina) {
				...
				xmlhttp.open ("GET", "../modelo/modelo_albaran_diferido.php?precios=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas+"&desdecodigo="+desdecodigo, true);
				xmlhttp.send();
	}
	...
	function preparoMostrarFacLineas() {
		...
		xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?acontar_alblineas="+"si"+"&numero_albaran="+numero_albaran, true);
		xmlhttp.send();
	}
	...
	function mostrarFacLineas(pagina) {
		...
		xmlhttp.open ("GET", "../modelo/modelo_albaran_diferido.php?alb_lineas=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas+"&numero_albaran="+numero_albaran, false);
		xmlhttp.send();
	}
	...
	function veoCab() {
				...
				xmlhttp.open ("GET", "../modelo/modelo_albaran_diferido.php?veo_cab=" + "si"+"&numero_albaran="+numero_albaran, false);
				xmlhttp.send();
	}
	...
	function leerRef()  {
		...
		xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?leer_ref="+"si", false);
		xmlhttp.send(); 
		actualizando=false;	     
	}
	...
	function guardarCambiosLinea(num_linea) {
		...
		var confirma=confirm("Grabar cambios?");
			...
			if (confirma) {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?regraba_linea="+"si"+"&numero_albaran="+g_numero_albaran+"&numero_linea="+num_linea+"&almacen_ori="+gr_alm_ori+"&articulo="+gr_articulo+"&descripcion="+gr_descripcion+"&unidades="+gr_unidades+"&precio="+gr_precio+"&tipo_iva="+gr_tipo_iva+"&iva_por="+gr_iva_por+"&iva_importe="+gr_iva_importe+"&descuento_por="+gr_descuento_por+"&descuento_importe="+gr_descuento_importe+"&precio_sin_iva="+pre_precio_linea+"&importe_linea="+gr_importe_linea, false);
				xmlhttp.send();
		}
	}
	function actualizaCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?actualiza_cab="+"si"+"&numero_albaran="+numero_albaran+"&old_importe_neto="+anterior_importe_neto+"&new_importe_neto="+gr_importe_neto+"&old_descuento_importe="+anterior_descuento_importe+"&new_descuento_importe="+gr_descuento_importe+"&old_iva_importe="+anterior_iva_importe+"&new_iva_importe="+gr_iva_importe+"&old_importe_total="+anterior_importe_linea+"&new_importe_total="+gr_importe_linea, false);
	...
	function regrabaCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?regraba_cab="+"si"+"&numero_albaran="+numero_albaran+"&importe_neto="+gr_importe_neto+"&descuento_importe="+pre_dto_importe+"&iva_importe="+pre_iva_importe+"&importe_total="+gr_importe_linea, false);
	...
	function buscaAlmacen(id_almacen) {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?busca_almacen="+"si"+"&id_almacen="+id_almacen,false);
				xmlhttp.send();
	}
	...
	function buscaCliente(id_cliente) {
			...
			var xmlhttp;
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?busca_cliente="+"si"+"&id_cliente="+id_cliente,false);
				xmlhttp.send();
	...
	function buscaPrecios(id_articulo) {
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?busca_precio="+"si"+"&id_articulo="+id_articulo,false);
				xmlhttp.send();
	}
	function calculaDto() {
	...
	function grabarHistorico_o() {
		...
		function grabaRef(){
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?graba_ref="+"si"+"$numero_linea="+numero_linea,false);
				xmlhttp.send();
	}
		function grabaRefNumeroAlb(){
				...
				xmlhttp.open("GET", "../modelo/modelo_albaran_diferido.php?graba_ref_numero_alb="+"si", false);
				xmlhttp.send();
	}
