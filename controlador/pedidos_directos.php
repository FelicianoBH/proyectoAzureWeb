...
<div class="container" style="border: 1px solid;padding:15px;margin-left:150 auto;">
						 ...
						 <div class="row">
							     <div class="col-md-2">
							      ...
							      <div class="col-md-3">
							       ...
							       <div class="col-md-2">
							      			<div>Núm:
									  			<input type="text" readonly id="numero_pedido"  size="16"/>
							      			</div>
							      </div>
							      </div>
					      <div class="row">
					      ...
					      <div class="row">
					       ...
					       <div class="row">
							     	 ...
							     	 <div class="col-md-3">
							      			<div><strong>Total Factura :</strong>
									  			<input type="text" readonly id="total_ped" size="3" maxlength="6" style="width:90px;height:28px;font-weight:bold;"/>
							      			</div>
							     	 </div>
					      </div>
					      	<hr>
	...
	<div id="plus_crud_general" style="margin-left:0px;"></div>
</div>
...
<script type="text/javascript">
	...
	var linea_opciones=document.getElementById("linea_botones");
	...
	var clasifica="";
	var desde_codigo_cliente="";
	var desde_nombre_cliente="";
	var desde_razon_cliente="";
	...
	var g_numero_pedido;
		...
		function agregarLineas(){
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?crear_pedido="+"si", false);
				xmlhttp.send();
		...
		function crearCabecera(){
			...
			if (operacion=="inicio") {
				...
				operacion="nuevopedido";

					document.getElementById("leyenda").innerHTML="PEDIDO NUEVO";
					document.getElementById("nuevaVentana").style.width="70%";
					overlay.style.opacity = .7;
					if (overlay.style.display == "block") {
						overlay.style.display="none";
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?crear_cabecera="+"si", false);
				xmlhttp.send();
		}
	}
	...
	*/
		function consultaClientes() {
				...
				resultadoconsulta.innerHTML=
					'<div class="container-fluid">'+
						'<div class="row">'+
							'<div class="col-md-3">'+
				    	  		'<div style="font-size:18px;font-weight:bold;">Consulta de Clientes'+'</div>'+
				    	  	'</div>'+
							'<div class="col-md-3">'+
								
								'<div style="font-size:16px;font-weight:bold;">Desde código:'+'<input type="text" id="desde_codigo_cliente" size="14" onchange="consultaDesdeCodigoCliente()"/>'+
				    	  			'</div>'+
				      		'</div>'+
				      		'<div class="col-md-3">'+
								'<div style="font-size:16px;font-weight:bold;">Desde Nombre:'+'<input type="text" id="desde_nombre_cliente" size="14" onchange="consultaDesdeNombreCliente()"/>'+
				    	  			'</div>'+
				      		'</div>'+
				      		'<div class="col-md-3">'+
								'<div style="font-size:16px;font-weight:bold;">Desde Razón:'+'<input type="text" id="desde_razon_cliente" size="14" onchange="consultaDesdeRazonCliente()"/>'+
				    	  			'</div>'+
				      		'</div>'+
				      	'</div>'+
				     '</div>';
		...
		function consultaDesdeCodigoCliente() {

			clasifica="codigo";
			desde_codigo_cliente = document.getElementById("desde_codigo_cliente").value;
			consultaDesdeCliente();
		}

		function consultaDesdeNombreCliente(){

			clasifica="nombre";
			desde_nombre_cliente = document.getElementById("desde_nombre_cliente").value;
			consultaDesdeCliente();
		}

		function consultaDesdeRazonCliente(){

			clasifica="razon";
			desde_razon_cliente = document.getElementById("desde_razon_cliente").value;
			consultaDesdeCliente();
		}

		function consultaDesdeCliente() {
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?clientes="+"si"+"&clasifica="+clasifica+"&desdecodigo="+desde_codigo_cliente+"&desderazon="+desde_razon_cliente+"&desdenombre="+desde_nombre_cliente+"&pagina="+'0'+"&num_paginas="+'999', false);
				xmlhttp.send();
		}

		function seleccionarCliente(num_cliente) {

				
				var nombrex="nombre"+num_cliente;
				var nifx="nif"+num_cliente;
				var direcionx="direccion"+num_cliente;
				var tlfx="tlf"+num_cliente;
				var cliente_nombre=document.getElementById(nombrex).innerHTML;
				var cliente_nif=document.getElementById(nifx).innerHTML;
				var cliente_direccion=document.getElementById(direcionx).innerHTML;
				var cliente_tlf=document.getElementById(tlfx).innerHTML;
				cierraVentana();
				crearCabecera();
				document.getElementById("cc_cliente").value=num_cliente;
				document.getElementById("cc_cliente_nombre").value=cliente_nombre;
				document.getElementById("cc_cliente_nif").value=cliente_nif;
				document.getElementById("cc_cliente_direccion").value=cliente_direccion;
				document.getElementById("cc_cliente_tlf").value=cliente_tlf;
				cliente_valido=true;
		}
		...
		function editarLinea(num_linea) {
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?detalle_linea="+"si", false);
				xmlhttp.send();
		...
		function muestraLinea(num_linea) {
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?muestra_linea="+"si"+"&num_pedido="+g_numero_pedido+"&num_linea="+num_linea, false);
				xmlhttp.send();
			}	
		...
		function borrarLinea(num_linea) {
				...
				if (confirma){
						...
						xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?borrar_linea="+"si"+"&num_pedido="+g_numero_pedido+"&num_linea="+num_linea, false);
							xmlhttp.send();
				}
		}
		...
		function editarCabecera() {
					...
					sw_consulta=true;
					document.getElementById("leyenda").innerHTML="EDITAR CABECERA";
					document.getElementById("nuevaVentana").style.width="60%";
					overlay.style.opacity = .7;
					if (overlay.style.display == "block") {
						overlay.style.display="none";
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?editar_cabecera="+"si", false);
				xmlhttp.send();
		...
		function muestraDatos() {
				...
				document.getElementById("ed_cliente").value= ed_cliente;
				document.getElementById("ed_cliente_nombre").value= ed_cliente_nombre;
				document.getElementById("ed_cliente_nif").value= ed_nif;
				document.getElementById("ed_cliente_direccion").value= ed_direccion;
				document.getElementById("ed_cliente_tlf").value= ed_tlf;
				document.getElementById("ed_alm_vta").value= ed_alm_vta;
				document.getElementById("ed_alm_descripcion").value= ed_alm_descripcion;
				document.getElementById("ed_observaciones").value= ed_observaciones;

		}

		function grabarCabecera() {

			if (cliente_valido&&almacen_valido) {

				var confirme=confirm("CONFORME PEDIDO NUEVO ?");
				...
				if (confirme) {
						...
						leerRef();
						var ped_tipo="PEDIDO";
						var ped_cliente=document.getElementById("cc_cliente").value;
						var ped_tlf=document.getElementById("cc_cliente_tlf").value;
						var ped_estado="nuevo";
						var ped_usuario='<?php echo $_SESSION["id_usuario"] ?>';
						var ped_domicilio_entrega=document.getElementById("cc_cliente_direccion").value;
						var ped_almacen_vta=document.getElementById("cc_alm_vta").value;
						var ped_observaciones=document.getElementById("cc_observaciones").value;
						...
						if(window.XMLHttpRequest) {
							...
							document.getElementById("cliente").value=ped_cliente;
							buscaCliente(ped_cliente);
							...
							document.getElementById("tlf").value=tlf_cliente;
							document.getElementById("alm_vta").value=ped_almacen_vta;
							document.getElementById("impuestos").value=0;
							document.getElementById("total_ped").value=0;
							document.getElementById("dtos").value=0;
							preparoMostrarFacLineas();	
							}
					}
						xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?grabar_cabecera="+"si"+"&ped_tipo="+ped_tipo+"&ped_cliente="+ped_cliente+"&ped_numero="+numero_pedido+"&ped_fecha="+fecha+"&ped_estado="+ped_estado+"&ped_usuario="+ped_usuario+"&ped_almacen_vta="+ped_almacen_vta+"&ped_domicilio_entrega="+ped_domicilio_entrega+"&ped_tlf="+ped_tlf+"&ped_observaciones="+ped_observaciones, false);
						xmlhttp.send();
				}
			}
        ...
        function guardarCambiosCabecera() {

        			if (cliente_valido&&almacen_valido) {

				var confirme=confirm("GRABAR CAMBIOS ?");

				if (confirme) {

						var ped_cliente=document.getElementById("ed_cliente").value;
						var ped_tlf=document.getElementById("ed_cliente_tlf").value;
						var ped_domicilio_entrega=document.getElementById("ed_cliente_direccion").value;
						var ped_almacen_vta=document.getElementById("ed_alm_vta").value;
						var ped_observaciones=document.getElementById("ed_observaciones").value;
						...
						if(window.XMLHttpRequest) {
							...
							document.getElementById("total_ped").value=0;
							document.getElementById("dtos").value=0;
							ed_cliente=ped_cliente;
			 				ed_cliente_nombre=nombre_cliente;
			 				ed_nif=nif_cliente;
			 				ed_direccion=ped_domicilio_entrega;
			 				ed_tlf=ped_tlf;
			 				ed_alm_vta=ped_almacen_vta;
			 				ed_observaciones=ped_observaciones;
							preparoMostrarFacLineas();	

							}
					}
		
						xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?regrabar_cabecera="+"si"+"&ped_cliente="+ped_cliente+"&ped_numero="+numero_pedido+"&ped_domicilio_entrega="+ped_domicilio_entrega+"&ped_tlf="+ped_tlf+"&ped_almacen_vta="+ped_almacen_vta+"&ped_observaciones="+ped_observaciones, false);
						xmlhttp.send();
				}
			}
		...
		xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?acontar_precios="+"si",true);
		xmlhttp.send();
	}
		...
		function mostrarPrecios(pagina) {
				...
				xmlhttp.open ("GET", "../modelo/modelo_pedidos_directo.php?precios=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas+"&desdecodigo="+desdecodigo, true);
				xmlhttp.send();
	}
	...
	function preparoMostrarFacLineas() {
		...
		xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?acontar_pedlineas="+"si"+"&numero_pedido="+numero_pedido, true);
		xmlhttp.send();
	}
	...
	function mostrarFacLineas(pagina) {
				...
				xmlhttp.onreadystatechange = function () {
					if (this.readyState === 4 && this.status === 200) {
						...
						g_numero_pedido=numero_pedido;
					}
				}
		xmlhttp.open ("GET", "../modelo/modelo_pedidos_directo.php?ped_lineas=" + "si"+"&pagina="+pagina+"&num_paginas="+num_paginas+"&numero_pedido="+numero_pedido, false);
		xmlhttp.send();
	}
	...
	function veoCab() {
				...
				if(window.XMLHttpRequest) {
					...
					if (this.readyState === 4 && this.status === 200) {
						...
						if (buenjason) {
			 			...
			 			document.getElementById("total_ped").value=obj.importe_total;
				...
				xmlhttp.open ("GET", "../modelo/modelo_pedidos_directo.php?veo_cab=" + "si"+"&numero_pedido="+numero_pedido, false);
				xmlhttp.send();
	}

	function lineaOpciones() {
				...
				if (this.readyState === 4 && this.status === 200) {
					...
					linea_opciones.innerHTML=xmlhttp.responseText;
				}
			}
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?opciones="+"si", true);
				xmlhttp.send();
	}
	...
	function leerRef()  {
		...
		xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?leer_ref="+"si", false);
		xmlhttp.send(); 
		actualizando=false;	     
	}
	...
	function grabarLinea() {
		...
		var confirma=confirm("Grabar linea de pedido?");
	...
	function guardarCambiosLinea(num_linea) {
		...
		var confirma=confirm("Grabar cambios?");
			...
			if (confirma) {
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?regraba_linea="+"si"+"&numero_pedido="+g_numero_pedido+"&numero_linea="+num_linea+"&almacen_ori="+gr_alm_ori+"&articulo="+gr_articulo+"&descripcion="+gr_descripcion+"&unidades="+gr_unidades+"&precio="+gr_precio+"&tipo_iva="+gr_tipo_iva+"&iva_por="+gr_iva_por+"&iva_importe="+gr_iva_importe+"&descuento_por="+gr_descuento_por+"&descuento_importe="+gr_descuento_importe+"&precio_sin_iva="+pre_precio_linea+"&importe_linea="+gr_importe_linea, false);
				xmlhttp.send();
		}
	}
	function actualizaCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?actualiza_cab="+"si"+"&numero_pedido="+numero_pedido+"&old_importe_neto="+anterior_importe_neto+"&new_importe_neto="+gr_importe_neto+"&old_descuento_importe="+anterior_descuento_importe+"&new_descuento_importe="+gr_descuento_importe+"&old_iva_importe="+anterior_iva_importe+"&new_iva_importe="+gr_iva_importe+"&old_importe_total="+anterior_importe_linea+"&new_importe_total="+gr_importe_linea, false);
	...
	function regrabaCab() {
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?regraba_cab="+"si"+"&numero_pedido="+numero_pedido+"&importe_neto="+gr_importe_neto+"&descuento_importe="+pre_dto_importe+"&iva_importe="+pre_iva_importe+"&importe_total="+gr_importe_linea, false);
	...
	function buscaAlmacen(id_almacen) {
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?busca_almacen="+"si"+"&id_almacen="+id_almacen,false);
				xmlhttp.send();
	}
	...
	function buscaCliente(id_cliente) {
			...
			var xmlhttp;
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?busca_cliente="+"si"+"&id_cliente="+id_cliente,false);
				xmlhttp.send();
	...
	function buscaPrecios(id_articulo) {
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?busca_precio="+"si"+"&id_articulo="+id_articulo,false);
				xmlhttp.send();
	}
	function calculaDto() {
	...
	function grabarHistorico_o() {
		...
		function grabaRef(){
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?graba_ref="+"si"+"$numero_linea="+numero_linea,false);
				xmlhttp.send();
	}
		function grabaRefNumeroFac(){
				...
				xmlhttp.open("GET", "../modelo/modelo_pedidos_directo.php?graba_ref_numero_ped="+"si", false);
				xmlhttp.send();
	}
	...
	function editarOtroPedido() {

			 numero_pedido=prompt("ENTRE NUMERO DE PEDIDO A EDITAR");
	...
	function cargaTeclas() {
	 		...
	 		$("#fl_almacen_ori").on('keyup', function(e){
				...
				if(keycode==13) {
						...
						if (document.getElementById("fl_dto_porcentaje").value=="")
						{
							document.getElementById("fl_dto_porcentaje").value=0.0;
						}
