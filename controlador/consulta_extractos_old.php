...
<div id="wrapper"> 
	<div id="crud_gral"></div>
	  ...
	  <div id="contengo" style="margin:0px auto;">
	  	...
	  	<form>
      		<fieldset>
      			<div id="div1">
					...
					<button type="button" class='botones' onclick="buscaCuenta()"><u>B</u>uscar</button>
      			</div>
				<div id="div2">
  		...
  		<table>
      			<tr>
      				<td><button type="button"  class='botones' onclick="todosMovimientos()"><u>T</u>ODOS LOS MOVIMIENTOS</button></td>
      				<td><button type="button" id="conciliados" class='botones' onclick="consultaConciliados()">C<u>O</u>nciliado</button></td>
					<td><button type="button" id="noconciliados" class='botones' onclick="consultaNoConciliados()"><u>S</u>in conciliar</button></td>
      				<td><button type="button" id="ambos" class='botones' onclick="consultaAmbos()">A<u>M</u>bos</button></td>
      				<td><button type="button" class='botones' onclick="preparaExtractos()">  B<u>U</u>SCAR </button></td>
      			</tr>
	 </table>
