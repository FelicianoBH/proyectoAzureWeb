...
if ($editar_cabecera=="si") {
	...
	if ($graba_linea=="si") {
		...
		$resultado=mysqli_query($con, "INSERT INTO albaran_lineas 
			(ALIN_NUMERO_ALBARAN, ALIN_NUMERO_LINEA, ALIN_ALMACEN_ORI, ALIN_CODIGO_ART, ALIN_DESCRIPCION, ALIN_UNIDADES, ALIN_PRECIO, ALIN_TIPO_IVA, ALIN_IVA_POR, ALIN_IMPORTE_IVA, ALIN_DESCUENTO_POR, ALIN_DESCUENTO_IMPORTE, ALIN_PRECIO_SIN_IVA, ALIN_IMPORTE_LINEA, ALIN_TIPO_DOCUMENTO_ORIGEN, ALIN_DOCUMENTO_ORIGEN) 
			VALUES 
			('$gr_numero_albaran', '$gr_numero_linea', '$gr_almacen_ori', '$gr_articulo', '$gr_descripcion', '$gr_unidades', '$gr_precio', '$gr_tipo_iva', '$gr_iva_por', '$gr_iva_importe', '$gr_descuento_por', '$gr_descuento_importe', '$gr_precio_sin_iva', '$gr_importe_linea', 'DIRECTO', ' ')");
	...
	if ($grabar_cabecera=="si") {
		...
		$resultado=mysqli_query($con, "INSERT INTO albaran_cab (ALB_TIPO, ALB_NUMERO, ALB_FECHA, ALB_CLIENTE, ALB_ESTADO, ALB_USUARIO, ALB_IMPORTE_NETO, ALB_IMPORTE_IVA, ALB_IMPORTE_DESCUENTO, ALB_IMPORTE_TOTAL, ALB_NUMERO_LINEAS, ALB_ALMACEN_VENTA, ALB_DOMICILIO_ENTREGA, ALB_TLF, ALB_OBSERVACIONES, ALB_TIPO_VENTA) 
			VALUES 
			('$alb_tipo', '$alb_numero', '$alb_fecha', '$alb_cliente', '$alb_estado', '$alb_usuario', '0.0', '0.0', '0.0', '0.0', '0', '$alb_almacen_vta', '$alb_domicilio_entrega', '$alb_tlf', '$alb_observaciones', '')");
