<?php 
	...
	if ($ayuda=="si") {
			...
			$cu='<div class="container">';
		 		 $cu.='<h2>Carousel Example</h2>';  
					$cu.='<div id="myCarousel" class="carousel slide" data-ride="carousel">';
				    $cu.='<!-- Indicators -->';
				    $cu.='<ol class="carousel-indicators">';
				      $cu.='<li data-target="#myCarousel" data-slide-to="0" class="active"></li>';
				      $cu.='<li data-target="#myCarousel" data-slide-to="1"></li>';
				      $cu.='<li data-target="#myCarousel" data-slide-to="2"></li>';
				    $cu.='</ol>';

				    $cu.='<!-- Wrapper for slides -->';
				    $cu.='<div class="carousel-inner">';
				      $cu.='<div class="item active">';
				        $cu.='<img src="/PROYECTO3/IMAGEN_SERVIDOR/ayuda.png" alt="Los Angeles" style="width:100%;">';
				      $cu.='</div>';

				      $cu.='<div class="item">';
				        $cu.='<img src="/PROYECTO3/IMAGEN_SERVIDOR/elsa_miPapa.jpg" alt="Chicago" style="width:100%;">';
				      $cu.='</div>';
				    
				      $cu.='<div class="item">';
				        $cu.='<img src="/PROYECTO3/IMAGEN_SERVIDOR/alina.jpg" alt="New york" style="width:100%;">';
				      $cu.='</div>';
				    $cu.='</div>';

				   $cu.=' <!-- Left and right controls -->';
				    $cu.='<a class="left carousel-control" href="#myCarousel" data-slide="prev">';
				      $cu.='<span class="glyphicon glyphicon-chevron-left"></span>';
				      $cu.='<span class="sr-only">Previous</span>';
				    $cu.='</a>';
				    $cu.='<a class="right carousel-control" href="#myCarousel" data-slide="next">';
				      $cu.='<span class="glyphicon glyphicon-chevron-right"></span>';
				      $cu.='<span class="sr-only">Next</span>';
				    $cu.='</a>';
				  $cu.='</div>';
				$cu.='</div>';
	...
	if($apuntes==="apuntes") {
			...
			$table .= '<th class="col-sm-2">Id Con</th>';
			$table .= '<th class="col-sm-1">Concepto</th>';
			$table .= '<th class="col-sm-1">D/H</th>';
			$table .= '<th class="col-sm-2">Debe</th>';
			$table .= '<th class="col-sm-2">Haber</th>';
			$table .= '</tr>';
			...
			$table .= '<td><input  id="'.$borrar.$fila['APUNTE'].'" onclick="borrarApunte('.$envio.')"  type = "button" value ="Borrar" class = "btn btn-danger"></td>';
