<?php 
	...
	if ($acontar=="si") {
		...
		if ($consultar=="a") {
 		...
 		if ($consultar=="n") {
 			$resultado = mysqli_query($con, "SELECT * FROM extractos WHERE EXT_CUENTA='$decuenta' AND EXT_FECHA  >= '$desde_fechaconver' AND EXT_ASIENTO >= '$desdeasto' AND EXT_APUNTE >= '00' AND EXT_FECHA <= '$hasta_fechaconver' AND EXT_ASIENTO <='$hastaasto' AND EXT_CONCILIADO=''");
 			}
...
/*		$resultado = mysqli_query($con, "SELECT * FROM extractos WHERE EXT_CUENTA='$decuenta' AND EXT_FECHA  >= '$desde_fechaconver' AND EXT_ASIENTO >= '$desdeasto' AND EXT_APUNTE >= '00' AND EXT_FECHA <= '$hasta_fechaconver' AND EXT_ASIENTO <='$hastaasto'"); */
	...
	if($extractos=="si") {
		...
		$hasta_fechaconver=date('Y-m-d', $hasta_fechaconver);
		if ($consultar=="a") {
 				$resultado = mysqli_query($con, "SELECT * FROM extractos WHERE EXT_CUENTA='$decuenta' AND EXT_FECHA  >= '$desde_fechaconver' AND EXT_ASIENTO >= '$desdeasto' AND EXT_APUNTE >= '00' AND EXT_FECHA <= '$hasta_fechaconver' AND EXT_ASIENTO <='$hastaasto' LIMIT  $desde,$tamanio");
 			}
 		if ($consultar=="s") {
 		...
 		if ($consultar=="n") {
 			$resultado = mysqli_query($con, "SELECT * FROM extractos WHERE EXT_CUENTA='$decuenta' AND EXT_FECHA  >= '$desde_fechaconver' AND EXT_ASIENTO >= '$desdeasto' AND EXT_APUNTE >= '00' AND EXT_FECHA <= '$hasta_fechaconver' AND EXT_ASIENTO <='$hastaasto' AND EXT_CONCILIADO='' LIMIT  $desde,$tamanio");
 			}
			$table = '<div class = "container">';
